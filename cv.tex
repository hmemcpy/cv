...
\begin{tabular}{p{0.9\textwidth}}
 I am a seasoned software developer with 20 years of professional experience across various domains and technologies.\\\
...
\begin{tabular}{rl}
  \textsc{Languages:}& Scala (expert), C\#, Java, TypeScript (proficient), Haskell (beginner), Rust, Python (learning)\\
