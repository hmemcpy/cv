...
\begin{tabular}{p{0.9\textwidth}}
 Senior backend/infrastructure engineer with over 20 years of experience building financial systems, developer platforms, IDE tooling, and production services. Strong focus on typed functional languages, AI-first agentic engineering, backend architecture, software correctness, and developer experience (DX).\\[0.35em]

 Open-source contributor and frequent speaker, with a long-running interest in tools that make developers more effective: compiler and IDE plugins, build tooling, workshops, technical writing, and hands-on mentoring.
\end{tabular}
...
\begin{longtable}{r|p{0.72\textwidth}}
  ...
  \textsc{Jan 2025--May 2026} & \job{Founding Engineer}{EurekaLabs}, Israel \\(1 year, 5 months)
    &Founding engineer (first hire), building infrastructure for Ethereum block construction. Led development of an Ethereum block builder written in Rust, spanning core product features and ongoing compatibility across network and protocol versions.\\&\\
  ...
  \textsc{Apr 2020--Mar 2024} & \job{Founding Engineer and Tech Lead}{Unit}, Israel \\(4 years)
    &Founding engineer (first hire). Grew the engineering organization and helped establish core backend architecture, engineering practices, testing standards, protocols, and workflows.\\&\\
  ...
  \hline
  \multicolumn{2}{r}{\footnotesize\itshape (abbreviated work history below, see LinkedIn for full details)}\\\sep
...
\begin{tabular}{rl}
  \textsc{Languages:}& Scala, Rust, Haskell, TypeScript, C\#, Java\\
  \textsc{Libraries:}& ZIO, TypeLevel, Tokio, Effect.ts\\
  \textsc{Practices:}& Architecture (ES/CQRS, DDD), testing (TDD, PBT, E2E), AI agent workflows\\
  \textsc{Technologies:}& Postgres, Redis, Docker, Kubernetes, Kafka, AWS\\
\end{tabular}
